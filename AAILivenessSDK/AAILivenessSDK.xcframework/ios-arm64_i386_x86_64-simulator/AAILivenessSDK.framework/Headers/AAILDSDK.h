...
+ (void)initWithAccessKey:(NSString *)accesskey secretKey:(NSString *)secretkey market:(AAILivenessMarket)market DEPRECATED_MSG_ATTRIBUTE("Please use 'initWithMarket:' instead");
...
+ (void)initWithAccessKey:(NSString *)accesskey secretKey:(NSString *)secretkey market:(AAILivenessMarket)market isGlobalService:(BOOL)isGlobalService DEPRECATED_MSG_ATTRIBUTE("Please use 'initWithMarket:isGlobalService:' instead");
